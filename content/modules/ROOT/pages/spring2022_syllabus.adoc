...
xref:spring2022_schedule.adoc[Click here to view the Spring 2022 Course Schedule]
...
It is very important to check the Brightspace page frequently! Please review the schedule below and on Brightspace. More details for each assignment will be available on Brightspace. *Due dates are listed above in the xref:spring2022_schedule.adoc[spring 2022 semester schedule]*
