...
- *Meeting Options*: Allow participants to join before start time. Also select “mute participants upon entry” since people will be joining at any time between 3-5 PM so we don’t want them to interrupt the conversation. 
